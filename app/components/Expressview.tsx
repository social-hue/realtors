...
const projectHighlights = [
    ...
    { icon: Building2, label: "Plot Sizes", value: "100-300 Sq. Yards" },
            ...
            <section className="pt-12 pb-8 bg-white">
                <div className="max-w-6xl lg:mx-auto mx-6">
                    ...
                    <div className="flex items-center gap-2 text-sm text-slate-500 mb-8">
                        ...
                        <span>/</span>
                        <span className="text-slate-900">Expressview By Kavvan</span>
                    </div>
                    ...
                    <p className="text-lg text-slate-600 mb-8 leading-relaxed border-l-4 border-amber-500 pl-5">
                        Express View City is an premium residential housing project spread across 10 acres, offering over 300 meticulously
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-slate-600 leading-relaxed mb-4">
                                Express View City is an premium residential housing project spread across 10 acres, offering over 300 meticulously
                                planned residential plots. Each plot ranges from 89 sq. yards to 350 sq. yards, providing ample space to build your dream
                                home.
                            </p>

                            <p className="text-slate-600 leading-relaxed">Express View City's prime location on major highways and its proximity to Dholera International Airport make it a highly
                                desirable address. The thoughtfully designed amenities enhance the quality of living, ensuring a blend of convenience,
                                comfort, and leisure for all residents.Whether you're looking to build a cozy home or a spacious villa, Express View City
                                offers the perfect plot to suityour needs.</p>
                        </div>

                        <div className="relative">
                            <div className="relative rounded-lg overflow-hidden shadow-xl">
                                <Image
                                    src="/expressview-new.png"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <div className="space-y-1 mb-4">
                                {[
                                    { label: "Dholera International Airport", distance: "5 km" },
                                    { label: "Dholera-Vadodara Highway", distance: "5 min" },
                                    { label: "Ahmedabad–Dholera Expressway", distance: "200 mtr" },
                                    { label: "National Maritime Museum", distance: "12 Km" },
                                    { label: "Dholera Industrial Hub", distance: "5 min" },
                                ].map((item, idx) => (
            ...
            <section className="py-16 bg-slate-900">
                <div className="max-w-6xl lg:mx-auto mx-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { name: "Project Brochure", icon: FileText, href: "/expressview-brochure.pdf" },
                            { name: "Master Plan", icon: Landmark, href: "/expressview-master.png" },
                            { name: "Location Map", icon: MapPin, href: "/expressview-location.png" },
