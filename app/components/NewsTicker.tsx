...
export default function NewsTicker() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 py-6">
      <div className="relative flex items-center bg-white/50 backdrop-blur-md px-6 py-2.5 border border-zinc-600/60 rounded-full shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] overflow-hidden group">
        
        {/* Subtle Label */}
        <div className="flex items-center gap-2 mr-6 border-r border-zinc-200 pr-6">
        ...
        <div className="relative w-full overflow-hidden">
          ...
          <div className="flex animate-marquee whitespace-nowrap">
            {newsItems.concat(newsItems).map((item, index) => (
              <span
                key={index}
                className="mx-8 text-zinc-600 text-sm tracking-wide whitespace-nowrap"
              >
                {item}
              </span>
            ))}
